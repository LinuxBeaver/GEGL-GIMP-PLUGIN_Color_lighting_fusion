...
Recreation of Color Lighting Fusions GEGL Graph. 


id=1 src-atop aux=[ ref=1
unsharp-mask scale=0 
brightness-contrast contrast=1.0 brightness=0
hue-chroma lightness=0 chroma=0
saturation scale=1 
shadows-highlights 

]

#hsvhue is an example of one of many blend modes
#id=1 gimp:layer-mode layer-mode=hsv-hue aux=[  ref=1 color value=#00d2ff  ]
